...
public class FachadaGui {
   ...
   public FachadaGui(aplicacion.FachadaAplicacion fa){
    ...
    public void nuevaVentanaUsuarios(){
        VUsuarios vu;
        vu= new VUsuarios(vp,true,this.fa);
        vu.setVisible(true);
    }
    public void nuevaVentanaCategorias(){
        VCategorias vc;
        vc=new VCategorias(vp, true, fa);
        vc.setVisible(true);
            
    }
    public void nuevaVentanaPrestamo(Integer libro, Integer ejemplar){
        VPrestamo vpr;
        vpr=new VPrestamo(vp, true, fa,libro,ejemplar);
        vpr.setVisible(true);
    }
