...
public class VLibro extends javax.swing.JDialog {
    ...
    public VLibro(java.awt.Frame parent, boolean modal, aplicacion.FachadaAplicacion fa, Libro libro, java.util.List<String> categorias, java.util.List<String> restoCategorias) {
        ...
        mTEjemplares.setPrestados(fa.prestados(idLibro));
        if (mTEjemplares.getRowCount()>0) {
            tablaEjemplares.setRowSelectionInterval(0, 0);
            btnBorrarEjemplar.setEnabled(true);
            if((mTEjemplares.getValueAt(tablaEjemplares.getSelectedRow(), 4))==null){
            ...
            .addGroup(panelGeneralAutoresLayout.createSequentialGroup()
                ...
                .addGroup(panelGeneralAutoresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelGeneralAutoresLayout.createSequentialGroup()
                        ...
                        .addComponent(textoTitulo, javax.swing.GroupLayout.DEFAULT_SIZE, 435, Short.MAX_VALUE))
                    .addGroup(panelGeneralAutoresLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(panelGeneralAutoresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(textoEditorial, javax.swing.GroupLayout.DEFAULT_SIZE, 199, Short.MAX_VALUE)
                            .addGroup(panelGeneralAutoresLayout.createSequentialGroup()
                    ...
                    .addGroup(panelGeneralAutoresLayout.createSequentialGroup()
                        ...
                        .addGroup(panelGeneralAutoresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelGeneralAutoresLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(textoNuevoAutor, javax.swing.GroupLayout.DEFAULT_SIZE, 234, Short.MAX_VALUE))
    ...
    private void btnBorrarEjemplarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarEjemplarActionPerformed
     ...
     if (me.getRowCount()==0){
         ...
         tablaEjemplares.setRowSelectionInterval(0, 0);
            if((me.getValueAt(tablaEjemplares.getSelectedRow(), 4))==null){
               botonPrestar.setEnabled(true);
               botonDevolver.setEnabled(false);
            }else{
               botonPrestar.setEnabled(false);
    ...
    private void botonPrestarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPrestarActionPerformed
        ModeloTablaEjemplares me= (ModeloTablaEjemplares)tablaEjemplares.getModel();
        if(!tablaEjemplares.getSelectionModel().isSelectionEmpty()){ 
            fa.getFachadaGui().nuevaVentanaPrestamo(idLibro,(Integer)((ModeloTablaEjemplares)tablaEjemplares.getModel()).getValueAt(tablaEjemplares.getSelectedRow(),0));
            me.setPrestados(fa.prestados(idLibro));
            tablaEjemplares.setRowSelectionInterval(0, 0);
            if (me.getValueAt(tablaEjemplares.getSelectedRow(), 0)==null){
                botonPrestar.setEnabled(false);
                botonDevolver.setEnabled(false);
            }
            else if((me.getValueAt(tablaEjemplares.getSelectedRow(), 4))==null){
               botonPrestar.setEnabled(true);
               botonDevolver.setEnabled(false);
            }else{
               botonPrestar.setEnabled(false);
    ...
    private void botonDevolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonDevolverActionPerformed
        ModeloTablaEjemplares me= (ModeloTablaEjemplares)tablaEjemplares.getModel();
        if(!tablaEjemplares.getSelectionModel().isSelectionEmpty()){       
            fa.devolver(this.idLibro,(Integer)tablaEjemplares.getValueAt(tablaEjemplares.getSelectedRow(), 0));
            me.setPrestados(fa.prestados(idLibro));
            tablaEjemplares.setRowSelectionInterval(0, 0);
            if (me.getValueAt(tablaEjemplares.getSelectedRow(), 0)==null){
                botonPrestar.setEnabled(false);
    ...
    private void tablaEjemplaresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaEjemplaresMouseClicked
        ModeloTablaEjemplares me= (ModeloTablaEjemplares)tablaEjemplares.getModel();
        if(!tablaEjemplares.getSelectionModel().isSelectionEmpty()){
            if(tablaEjemplares.getValueAt(tablaEjemplares.getSelectedRow(), 0)==null){
                botonPrestar.setEnabled(false);
                botonDevolver.setEnabled(false);
            }else if((me.getValueAt(tablaEjemplares.getSelectedRow(), 4))==null){
               botonPrestar.setEnabled(true);
